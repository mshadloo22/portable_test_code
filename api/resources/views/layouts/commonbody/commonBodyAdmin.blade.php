                    ...
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                ...
                                <li class="dropdown">
                                    <a class="dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Manage Question</a>
                                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                        <li class="dropdown"><a  href="{{ url('/Question/create') }}">Add Question</a></li>
                                        <li class="dropdown"><a  href="{{ url('/Question') }}">List Question</a></li>
                                        </ul>
                                </li><!--#end manage questions -->
                            </ul>
                        </li>
                        <!-- end management -->
