 ...
 * Generated for Laravel 5.7.28 on 2019-06-20 13:08:19.
 *
...
namespace Illuminate\Support\Facades { 
    ...
    class App {
        ...
        /**
         * Get the path to the web / web directory.
         *
         * @return string 
         * @static 
         */ 
    ...
    class Artisan {
        ...
        public static function handle($input, $output = null)
        {
            //Method inherited from \Illuminate\Foundation\Console\Kernel            
                        /** @var \tutuorfinder\Console\Kernel $instance */
